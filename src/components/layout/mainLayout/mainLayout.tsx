        ...
        <div className="fixed h-screen bg-[#37475F] w-64 px-6 py-3 overflow-y-scroll">
          ...
          <div className="mt-12">
            ...
            <div className="mb-6">
              ...
              >
                ...
                >
                  <div className="border-l-2 border-[#6481AD] ml-2 mt-4 cursor-pointer" onClick={() => {
                    ...
                    <p
                      className={`prose prose-sm font-['Montserrat',sans-serif] font-semibold ${path === 'dashboard/' ? `text-white pl-2` : `text-[#6481AD]`}`}>—
                      Все</p>
                  </div>
                  <div className="border-l-2 border-[#6481AD] ml-2 pt-4 cursor-pointer">
                    <p className="text-[#6481AD] prose prose-sm font-['Montserrat',sans-serif] font-semibold w-full">—
                      Необработанные</p>
                  </div>
                  <div className="border-l-2 border-[#6481AD] ml-2 pt-4 cursor-pointer">
                    <p className="text-[#6481AD] prose prose-sm font-['Montserrat',sans-serif] font-semibold w-full">—
              ...
              <div
                className={`pl-2 flex items-center gap-x-4 mt-2 cursor-pointer py-2 ${(path === 'message/' || path === 'message/addMessage/') && 'bg-[#848F9F] rounded'}`}
                onClick={() => {
                  router.push('/message');
              }}>
